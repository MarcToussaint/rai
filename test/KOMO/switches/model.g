...
frame stem(table1) {
    ...
    shape:ssBox mass:.5 size:[0.1 0.1 .2 .03] }
frame arm1(stem) {
    joint:quatBall A:<t(0 0 .1)>  B:<d(90 1 0 0) t(0 0 .25) > Q:<d(-60 1 0 0)>
    shape:ssBox mass:1 size:[0.1 0.1 .5 .03] }
frame arm2(arm1) {
    joint:hingeX  A:<t(0 0 .25)> B:<t(0 0 .25) > q:1.
    shape:ssBox mass:1 size:[0.1 0.1 .5 .03] }
frame arm3(arm2) {
    joint:hingeX A:<t(0 0 .25)>  B:<t(0 0 .15) > q:1.
    shape:ssBox mass:1 size:[0.1 0.1 .3 .03] }

frame endeff(arm3) {
    shape:ssBox Q:<t(0 0 .2)> size:[.05 .05 .1 .02] color:[1. 1. 0] }
