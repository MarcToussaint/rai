...
trayG (table_base) 	{  Q:[.4, .1, 0], shape:ssBox, size:[0.07, 0.07, 0.01, 0.005], color:[0, .6, 0], logical:{ is_box, is_place } }

trayB (table_base) 	{  Q:[-.3, .3, 0], shape:ssBox, size:[0.07, 0.07, 0.01, 0.005], color:[0, 0, .6], logical:{ is_box, is_place } }
