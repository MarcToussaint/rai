...
body waist { X=<T t(0 0 .7) d(90 0 1 0)>  type=ST_capsule mass=1 size=[0. 0. .15 .1] }

body back     { type=ST_capsule mass=1 size=[0. 0. .1 .1] }
body chest    { type=ST_capsule mass=1 size=[0. 0. .2 .1] }
body shoulders{ type=ST_capsule mass=1 size=[0. 0. .2 .1] }
body shoulderL{ type=ST_sphere mass=.1 size=[0. 0. .1 .08]  }
body shoulderR{ type=ST_sphere mass=.1 size=[0. 0. .1 .08]  }
body upArmL   { type=ST_capsule mass=.1 size=[.1 .1 .1 .05]  }
body upArmR   { type=ST_capsule mass=.1 size=[.1 .1 .1 .05]  }
body dnArmL   { type=ST_capsule mass=.1 size=[.1 .1 .1 .05]  }
body dnArmR   { type=ST_capsule mass=.1 size=[.1 .1 .1 .05]  }
body upWristL { type=ST_capsule mass=.1 size=[.1 .1 .1 .045] }
body upWristR { type=ST_capsule mass=.1 size=[.1 .1 .1 .045] }

body neck { type=ST_capsule mass=.1 size=[.0 .0 .1 .05] }
body head { type=ST_sphere mass=.1 size=[0 0 0 .14] }
...
body dnWristR { type=ST_capsule mass=.01 size=[.1 .1 .1 .04] }
body dnWristL { type=ST_capsule mass=.01 size=[.1 .1 .1 .04] }
body ddnWristR{ type=ST_capsule mass=.01 size=[.5 .5 .04 .03] }
body ddnWristL{ type=ST_capsule mass=.01 size=[.5 .5 .04 .03] }
body handR    { type=ST_box mass=.01 size=[.05 .02 .05 .05] }
body handL    { type=ST_box mass=.01 size=[.05 .02 .05 .05] }
...
body lhip { mass=1 size=[.1 .1 .02 .08] type=ST_capsule }
body rhip { mass=1 size=[.1 .1 .02 .08] type=ST_capsule }
body lup  { mass=1 size=[.1 .1 .26 .07] type=ST_capsule } 
body rup  { mass=1 size=[.1 .1 .26 .07] type=ST_capsule } 
body ldn  { mass=1 size=[.1 .1 .3 .06] type=ST_capsule } 
body rdn  { mass=1 size=[.1 .1 .3 .06] type=ST_capsule } 
body lfoot{ mass=1 size=[.1 .3 .05 .05] type=ST_box } 
body rfoot{ mass=1 size=[.1 .3 .05 .05] type=ST_box fixed }
...
body rightTarget { type=ST_sphere size=[0 0 0 .03] X=<T t(-0.2 -0.4 1.1)> color=[1 0 0] }
body leftTarget  { type=ST_sphere size=[0 0 0 .03] X=<T t( 0.2 -0.4 1.1)> color=[1 0 0] }
