...
body ball2 { X=<T t(.15 -2.5 1.9)>  shape:box mass=.1 size=[.6 .1 .6 .3] color=[1 0 0] contact }
...
joint (arm3 arm4) { joint:hingeX A=<T t(0 0 0.2) d(45 0 0 1) > B=<T t(0 0 .2) > limits=[-.1 .1] agent=1 }
joint j4(arm4 arm5) { joint:hingeX A=<T t(0 0 0.2) d(45 0 0 1) > B=<T t(0 0 .2) > limits=[-.1 .1] agent=1 }
joint (arm5 arm6) { joint:hingeX A=<T t(0 0 0.2) d(45 0 0 1) > B=<T t(0 0 .2) > limits=[-.1 .1] agent=1 }
