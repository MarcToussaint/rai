...
stem { X: "t(0 0 1) d(90 0 0 1)"  shape:capsule mass=.1 size=[2 .1] }
...
#ball  { X: "t(.0 -1.0 2.1)"  shape:sphere mass=.1 size=[.1] color=[1 0 0] contact }
ball2 { X: "d(90 0 0 1) t(.15 -2.5 1.9)"  shape:box mass=.1 size=[.6 .1 .6] color=[1 0 0] contact }
#ball3 { X: "t(-.22 -1.5 2.)"  shape:sphere mass=.1 size=[.1] color=[1 0 0] contact }
