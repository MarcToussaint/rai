...
body stem { X=<T t(0 0 1) d(90 0 0 1)>  type=capsule mass=.1 size=[0.1 0.1 2 .1] fixed, }
...
body ball2 { X=<T d(90 0 0 1) t(.15 -2.5 1.9)>  type=box mass=.1 size=[.6 .1 .6 .3] color=[1 0 0] contact }
