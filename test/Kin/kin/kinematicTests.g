...
joint transRot (base stem){ B=<T t(0 0 .6)> type=JT_phiTransXY } #phiTransXY=12 #transXYPhi=8
...
joint (arm2 arm3) { A=<T t(0 0 0.15)> B=<T t(0 0 .15)> axis=[1 0 0] type=JT_free } #free
