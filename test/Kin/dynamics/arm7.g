...
joint1 (stem) { joint:hingeX origin: "t(0 0 1) d(90 1 0 0) "  limits=[-.1 .1]}
joint2 (arm1) { joint:hingeX origin: "t(0 0 0.2) d(45 0 0 1) " limits=[-.1 .1] }
joint3 (arm2) { joint:hingeX origin: "t(0 0 0.2) d(45 0 0 1) " limits=[-.1 .1] }
joint4 (arm3) { joint:hingeX origin: "t(0 0 0.2) d(45 0 0 1) " limits=[-.1 .1] }
joint5 (arm4) { joint:hingeX origin: "t(0 0 0.2) d(45 0 0 1) " limits=[-.1 .1] }
joint6 (arm5) { joint:hingeX origin: "t(0 0 0.2) d(45 0 0 1) " limits=[-.1 .1] }
joint7 (arm6) { joint:hingeX origin: "t(0 0 0.2) d(45 0 0 1) "  }
#joint7 (arm6) { joint:hingeX origin: "t(0 0 0.2) d(45 0 0 1) "  mimic: j4 }
