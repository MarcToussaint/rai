...
#hyperedge(B C not_existing) = 5  # keys=hyperedge, value=5, parents=B C This throws a parsing error, because non_existing does not exist
...
## merging: after reading all nodes, the Graph takes all Edit nodes, deletes the Edit tag, and calls a merge()
