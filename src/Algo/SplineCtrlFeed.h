...
struct ConstCtrlReference : rai::ReferenceFeed {
  rai::Var<arr> position_ref; ///< if set, defines a non-zero velocity reference
  rai::Var<arr> velocity_ref; ///< if set, defines a non-zero velocity reference

  ConstCtrlReference& setVelocityReference(const arr& _velocity_ref){ velocity_ref.set() = _velocity_ref; return *this; }
  ConstCtrlReference& setPositionReference(const arr& _position_ref){ position_ref.set() = _position_ref; return *this; }
