...
//     arr Japp(_J.d0,3*n);
//     Japp.setZero();
//     Japp.setMatrixBlock(_J.sub({0,0},{0,n}), 0, 1*n); //w.r.t. q1
//     Japp.setMatrixBlock((-0.5/tau)*_J.sub({0,0},{n,0}), 0, 0); //w.r.t. q0
//     Japp.setMatrixBlock(( 0.5/tau)*_J.sub({0,0},{n,0}), 0, 2*n); //w.r.t. q2
//     J.append(Japp);
//   }
...
//       arr Japp(_J.d0,3*n);
//       Japp.setZero();
//       Japp.setMatrixBlock(_J.sub({0,0},{0,n}) - (1./tau)*_J.sub({0,0},{n,0}), 0, 0); //w.r.t. q0
//       Japp.setMatrixBlock((1./tau)*_J.sub({0,0},{n,0}), 0, 1*n); //w.r.t. q1
//       J.append(Japp);
//     }
//   }
...
//       arr Japp(_J.d0,3*n);
//       Japp.setZero();
//       Japp.setMatrixBlock(_J.sub({0,0},{0,n}) + (1./tau)*_J.sub({0,0},{n,0}), 0, 2*n); //w.r.t. q2
//       Japp.setMatrixBlock((-1./tau)*_J.sub({0,0},{n,0}), 0, 1*n); //w.r.t. q1
//       J.append(Japp);
//     }
//   }
