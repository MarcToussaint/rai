...
struct GenericZeroOrder{
  ...
  GenericZeroOrder(str method, shared_ptr<NLP> _P, const arr& x_init, std::shared_ptr<OptOptions> _opt) : P(_P), opt(_opt), method(method), best_x(x_init) {}
