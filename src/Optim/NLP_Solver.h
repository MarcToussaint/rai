...
struct NLP_Solver : NonCopyable {
  ...
  NLP_Solver& setTracing(bool trace_x, bool trace_errs, bool trace_phi, bool trace_J) { CHECK(P, "you need to set the problem first"); P->setTracing(trace_x, trace_errs, trace_phi, trace_J); return *this; }
