...
echo "const std::string tensorFS = R\"(" >> shaders.cxx
cat shaderTensor.fs >>shaders.cxx
echo ")\";" >>shaders.cxx
echo "//=============================" >> shaders.cxx
echo "const std::string tensorVS = R\"(" >> shaders.cxx
cat shaderTensor.vs >>shaders.cxx
echo ")\";" >>shaders.cxx
echo "//=============================" >> shaders.cxx
