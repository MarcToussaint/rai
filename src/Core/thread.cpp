...
Thread::Thread(const char* _name, double beatIntervalSec): ConditionVariable(tsEndOfMain), name(_name), tid(0), thread(0), step_count(0), metronome(beatIntervalSec), verbose(0) {
