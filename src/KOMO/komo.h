...
struct KOMO{
  ...
  Graph getReport(bool gnuplt=false, int reportFeatures=0); ///< return a 'dictionary' summarizing the optimization results (optional: gnuplot task costs; output detailed cost features per time slice)
