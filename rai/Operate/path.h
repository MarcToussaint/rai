...
std::pair<arr,arr> computePath(const rai::KinematicWorld& K, const arr& target_q, const StringA& target_joints={}, const char* endeff=NULL, double up=.2, double down=.8);
