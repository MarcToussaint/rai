...
PrimalDualProblem::PrimalDualProblem(const arr& x, const shared_ptr<MathematicalProgram>& P, OptOptions opt, arr& lambdaInit)
...
OptPrimalDual::OptPrimalDual(arr& x, arr& dual, const shared_ptr<MathematicalProgram>& P, int verbose, OptOptions opt)
