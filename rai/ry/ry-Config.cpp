...
//    return pybind11::array(q.dim(), q.p);
  ...
  .def("feature", [](shared_ptr<rai::Configuration>& self, FeatureSymbol featureSymbol, const ry::I_StringA& frameNames) {
    return symbols2feature(featureSymbol, I_conv(frameNames), *self);
  },
