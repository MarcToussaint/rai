...
{
  return ccdGJKIntersectRai(obj1, obj2, ccd, v1, v2, 0);
}

int ccdGJKIntersectRai(const void *obj1, const void *obj2, const ccd_t *ccd, ccd_vec3_t* v1, ccd_vec3_t* v2, ccd_vec3_t _simplex[8])
{
    ccd_simplex_t simplex;
