...
F_PairCollision::F_PairCollision(int _i, int _j, Type _type, bool _neglectRadii)
  : i(_i), j(_j), type(_type), neglectRadii(_neglectRadii) {
}

F_PairCollision::F_PairCollision(const rai::Configuration& K, const char* s1, const char* s2, Type _type, bool neglectRadii)
...
F_PairCollision::~F_PairCollision() {
}

void F_PairCollision::phi(arr& y, arr& J, const rai::Configuration& C) {
...
rai::Graph F_PairCollision::getSpec(const rai::Configuration& K) {
