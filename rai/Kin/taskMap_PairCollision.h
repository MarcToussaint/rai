...
struct TaskMap_PairCollision : TaskMap{
  ...
  TaskMap_PairCollision(int _i, int _j, bool negScalar=false, bool neglectRadii=false);
  TaskMap_PairCollision(const mlr::KinematicWorld& K, const char* s1, const char* s2, bool negScalar=false, bool neglectRadii=false);
