...
struct TM_LinVel : Feature {
  ...
  TM_LinVel(const rai::Configuration& K, const char* iShapeName=NULL) : i(initIdArg(K,iShapeName)) { order=1; }
...
struct TM_AngVel : Feature {
  ...
  TM_AngVel(const rai::Configuration& K, const char* iShapeName=NULL) : i(initIdArg(K,iShapeName)) { order=1; }
...
struct TM_LinAngVel : Feature {
  ...
  TM_LinAngVel(const rai::Configuration& K, const char* iShapeName=NULL) : i(initIdArg(K,iShapeName)) { order=1; }
...
struct TM_NoJumpFromParent : Feature {
  ...
  TM_NoJumpFromParent(const rai::Configuration& K, const char* iShapeName=NULL) : i(initIdArg(K,iShapeName)) { order=1; }
