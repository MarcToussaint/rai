...
struct TM_Contact_POA : Feature {
  ...
  TM_Contact_POA(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_Contact_Force : Feature {
  ...
  TM_Contact_Force(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_Contact_ForceIsNormal : Feature {
  ...
  TM_Contact_ForceIsNormal(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_Contact_ForceIsComplementary : Feature {
  ...
  TM_Contact_ForceIsComplementary(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_Contact_ForceIsPositive : Feature {
  ...
  TM_Contact_ForceIsPositive(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_Contact_POAmovesContinuously : Feature {
  ...
  TM_Contact_POAmovesContinuously(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_ContactConstraints_Vel : Feature {
  ...
  TM_ContactConstraints_Vel(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_Contact_POAzeroRelVel : Feature {
  ...
  TM_Contact_POAzeroRelVel(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL)
...
struct TM_Contact_POAisInIntersection_InEq : Feature {
  ...
  TM_Contact_POAisInIntersection_InEq(const rai::Configuration& K, const char* aShapeName=NULL, const char* bShapeName=NULL, double _margin=0.)
