...
//    map = new ProxyConstraint(TMT_allExceptListedP, shapes, (params?params->get<double>("margin", 0.1):0.1));
    ...
    }else if(params["ref1"]) map = new TM_qItself(QIP_byJointNames, {params.get<mlr::String>("ref1")}, world);
    ...
    map = new TM_GJK(world, params.get<mlr::String>("ref1"), params.get<mlr::String>("ref2"), true);
  }else{
