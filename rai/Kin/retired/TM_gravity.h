...
struct TM_Gravity2 : Feature {
  ...
  TM_Gravity2(const rai::Configuration& K, const char* iShapeName=NULL) : TM_Gravity2(initIdArg(K,iShapeName)){}
...
struct TM_ZeroAcc : Feature {
  ...
  TM_ZeroAcc(const rai::Configuration& K, const char* iShapeName=NULL) : TM_ZeroAcc(initIdArg(K,iShapeName)){}
